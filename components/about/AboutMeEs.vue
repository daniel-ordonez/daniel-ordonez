<template>
  <div id="about-me">
    <h2>Sobre mí</h2>
      ...
      <p>A veces ganas, a veces pierdes, y cuando vuelves a intentarlo aprendes.</p>
    ...
    <blockquote>
      <mark>Vive aprendiendo y disfrutando la vida, diseña para mejorar las cosas, trabaja en el cambio, intenta hacerlo mejor que ayer y comparte qué te hace feliz.</mark>
    </blockquote>
      <p>Resumido como:<br>Aprender + Disfrutar + Diseñar + Crear + Repetir ❤️</p>
      <p>Tal vez suena a discurso de concurso, pero como dije "quiero ser un soñador idealista"</p>
      <p>No busco la perfección para nada, pero si hay algo que no es bueno, puede mejorar y ser bueno, y cuando sea bueno, puede mejorar y ser grandioso, y después asombroso, y después increible.</p>
      <p>Y creo que eso se puede conseguir con los pasos de arriba.</p>
  </div>
</template>
